...
final StoryConfig redHatStory = StoryConfig(
  title: 'Chapeuzinho Vermelho',
  storyId: 'red_hat',
  primaryColor: Colors.red.shade600,
  accentColor: Colors.red.shade700,
  audioBasePath: 'sounds/redHat',
  ...
  pages: [
    ...
    StoryPage(
      pageNumber: 5,
      text:
          """O lobo já pensando na próxima refeição, perguntou por quê não levar essas formosas flores? Chapeuzinho gostou da ideia e entrou na floresta para colher flores. Distraida, nem percebeu que o lobo astuto saiu correndo para a casa da vovó.
    """,
      imageDescription:
